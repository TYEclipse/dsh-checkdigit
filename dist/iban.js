...
export function ibanDetail(value) {
    const parts = parseIban(value);
    if (parts === undefined)
        return undefined;
    return {
 ...
 */
export function generateIbanCheck(payload) {
